...
А здесь довольно интересные итоги. Не simd версия (читай как автовекторизованная) 
на GCC оказалось быстрее аналогичной на CLANG, вероятнее всего GCC генерирует код 
получге. Но есть еще одно интересные наблюдения:

avx512bw - медленнее почти в 2 раза, чем аналогичный бенчмарк на CLANG, более того
более старый набор инструкций avx2 оказался быстрее. Не знаю с чем это связано,
не будем исключать статистическую ошибку.

А с инструкциями семейства sse наоборот. GCC победил. Кстати, из этого следует 
победа в no_simd версии, т.к. компилятор любит автовекторизовать именно sse 
инструкциями.
